<?php	
//----------------------------------------------------------------------
//                    Ερώτημα από Combo Box "Εταιρίες"
//----------------------------------------------------------------------
$db = new mysqli('localhost','OTEADMIN','123456','oteshop'); 		
	
if ($_POST['moneytext']==0){
	$sql = 'SELECT * FROM products WHERE company="'.$_POST['searchFor'].'" ORDER BY price';  
}else{
	$sql = 'SELECT * FROM products WHERE company="'.$_POST['searchFor'].'" AND price<='.$_POST['moneytext'].'  ';   
}		
